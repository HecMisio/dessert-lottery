...
NETWORK_ARGS := --rpc-url http://localhost:8545 --account Alice --broadcast

ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --account Alice --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
